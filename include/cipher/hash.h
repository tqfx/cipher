...
#ifndef CIPHER_HASH_H
#define CIPHER_HASH_H
...
{
#if defined(CIPHER_MD5_H)
    md5_s md5[1];
#endif /* CIPHER_MD5_H */
#if defined(CIPHER_SHA1_H)
    sha1_s sha1[1];
#endif /* CIPHER_SHA1_H */
#if defined(CIPHER_SHA256_H)
    sha256_s sha256[1];
#endif /* CIPHER_SHA256_H */
#if defined(CIPHER_SHA512_H)
    sha512_s sha512[1];
#endif /* CIPHER_SHA512_H */
#if defined(CIPHER_SHA3_H)
    sha3_s sha3[1];
#endif /* CIPHER_SHA3_H */
#if defined(CIPHER_BLAKE2S_H)
    blake2s_s blake2s[1];
#endif /* CIPHER_BLAKE2S_H */
#if defined(CIPHER_BLAKE2B_H)
    blake2b_s blake2b[1];
#endif /* CIPHER_BLAKE2B_H */
} hash_u;
